...
const Icon = (0, react__WEBPACK_IMPORTED_MODULE_0__.forwardRef)(({
    ...
    const iconElements = iconNode && Array.isArray(iconNode) ? iconNode.map(([tag, attrs], index) => 
...
const __iconNode = Object.freeze([
    Object.freeze([
        "path",
        Object.freeze({
...
const toKebabCase = (string) => typeof string === "string" ? string.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase() : "";

const mergeClasses = (...classes) => classes
    .flat(Infinity)
    .filter((className, index, array) => typeof className === "string" && className.trim() !== "" && array.indexOf(className) === index)
    .join(" ")
    .trim();
